...
pwa_red = approx(f, Convex(), ProgressiveFitting(optimizer = optimizer, tolerance = 0.05, pen = :max))
plot(x, z, pwa_red)
...
pwa_red = approx(vals, Convex(), ProgressiveFitting(optimizer = optimizer, tolerance = 0.5, pen = :max))
